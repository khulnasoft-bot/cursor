...
export class AgentMemory {
    ...
    updateMemory(memoryId: string, updates: Partial<MemoryEntry>): boolean {
        ...
        this.logger.info(`Updated memory ${memoryId}`)
        return true
    }
    ...
    deleteMemoriesByType(type: MemoryType): number {
        ...
        this.logger.info(`Deleted ${count} memories of type ${type}`)
        return count
    }
    ...
    clearOldMemories(olderThan: Date): number {
        ...
        this.logger.info(`Cleared ${count} old memories`)
        return count
    }
    ...
    clearAllMemories(): void {
        ...
        this.memories.clear()
        this.logger.info(`Cleared all ${count} memories`)
    }
    ...
    private pruneMemories(): void {
        ...
        this.logger.info(`Pruned ${toRemove.length} memories`)
    }
    ...
    reset(): void {
        ...
        this.logger.info('Reset agent memory')
    }
}
...
export function destroyAgentMemory(): void {
    if (agentMemory) {
