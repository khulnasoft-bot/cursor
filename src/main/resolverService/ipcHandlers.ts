...
export function setupResolverServiceIpcs() {
    ...
    ipcMain.handle('resolver-service-get-token', async () => {
        try {
    ...
    // Get connection data
    ipcMain.handle('resolver-service-get-data', async () => {
        try {
    ...
    // Check if connected
    ipcMain.handle('resolver-service-is-connected', async () => {
        try {
    ...
    // Disconnect
    ipcMain.handle('resolver-service-disconnect', async () => {
        try {
