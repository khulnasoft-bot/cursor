...
export function setupAutomationsIpcs(): void {
    ...
    // Automation Service
    ipcMain.handle('automation-activate', async () => {
        try {
    ...
    ipcMain.handle('automation-deactivate', async () => {
        try {
    ...
    ipcMain.handle(
        ...
        async (
            ...
            try {
                const updated = automationService.updateWorkflow(
                    workflowId,
                    updates
                )
    ...
    // Trigger System
    ipcMain.handle('automation-activate-triggers', async () => {
        try {
    ...
    ipcMain.handle('automation-deactivate-triggers', async () => {
        try {
    ...
    ipcMain.handle('automation-get-actions', async () => {
        try {
    ...
    ipcMain.handle('automation-activate-scheduler', async () => {
        try {
    ...
    ipcMain.handle('automation-deactivate-scheduler', async () => {
        try {
    ...
    ipcMain.handle(
        ...
        async (
            ...
            try {
                const task = automationScheduler.scheduleWorkflow(
                    workflowId,
                    schedule
                )
    ...
    ipcMain.handle(
        ...
        async (_event: IpcMainInvokeEvent, workflowId: string) => {
            try {
                const stats =
                    automationLogger.getExecutionStatistics(workflowId)
        ...
        async (_event: IpcMainInvokeEvent, category?: string) => {
            try {
                const templates = category
                    ? automationTemplates.getTemplatesByCategory(
                          category as any
                      )
    ...
    ipcMain.handle(
        ...
        async (
            ...
            try {
                const workflow = automationTemplates.createWorkflowFromTemplate(
                    templateId,
                    overrides
                )
