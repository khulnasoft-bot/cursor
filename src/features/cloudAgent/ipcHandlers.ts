...
export function setupCloudAgentIpcs(): void {
    ...
    // Cloud Agent Service
    ipcMain.handle('cloud-agent-activate', async () => {
        try {
    ...
    ipcMain.handle('cloud-agent-deactivate', async () => {
        try {
    ...
    ipcMain.handle('cloud-agent-get-configs', async () => {
        try {
    ...
    ipcMain.handle(
        ...
        async (_event: IpcMainInvokeEvent, configId: string) => {
            try {
                const instance =
                    await cloudAgentService.provisionInstance(configId)
    ...
    ipcMain.handle(
        ...
        async (_event: IpcMainInvokeEvent, instanceId: string) => {
            try {
                const instance =
                    await cloudAgentService.deprovisionInstance(instanceId)
                return { success: true, instance }
            } catch (error) {
    ...
    ipcMain.handle('cloud-agent-get-instances', async () => {
        try {
    ...
    // Cloud Security
    ipcMain.handle('cloud-security-activate', async () => {
        try {
    ...
    ipcMain.handle('cloud-security-get-api-keys', async () => {
        try {
    ...
    ipcMain.handle('execution-environment-activate', async () => {
        try {
    ...
    ipcMain.handle(
        ...
        async (_event: IpcMainInvokeEvent, config: any) => {
            try {
                const environment =
                    executionEnvironment.createEnvironment(config)
    ...
    ipcMain.handle('execution-environment-get-environments', async () => {
        try {
    ...
    // Resource Manager
    ipcMain.handle('resource-manager-activate', async () => {
        try {
    ...
    ipcMain.handle('resource-manager-get-quotas', async () => {
        try {
    ...
    ipcMain.handle('resource-manager-get-usage', async () => {
        try {
    ...
    // Scaling Manager
    ipcMain.handle('scaling-manager-activate', async () => {
        try {
    ...
    ipcMain.handle('scaling-manager-get-policies', async () => {
        try {
    ...
    // Cloud Monitor
    ipcMain.handle('cloud-monitor-activate', async () => {
        try {
    ...
    ipcMain.handle('cloud-monitor-get-alerts', async () => {
        try {
    ...
    ipcMain.handle('cloud-monitor-get-health', async () => {
        try {
