...
export function setupVisualEditorIpcs(): void {
    ...
    ipcMain.handle('visual-editor-activate', async () => {
        try {
    ...
    ipcMain.handle('visual-editor-deactivate', async () => {
        try {
    ...
    // Check if active
    ipcMain.handle('visual-editor-is-active', async () => {
        try {
    ...
    // Deselect element
    ipcMain.handle('visual-editor-deselect-element', async () => {
        try {
    ...
    ipcMain.handle('visual-editor-get-selected', async () => {
        try {
    ...
    // Clear hover
    ipcMain.handle('visual-editor-clear-hover', async () => {
        try {
    ...
    ipcMain.handle(
        ...
        async (
            ...
            try {
                const change = visualEditorService.updateElementProperty(
                    elementId,
                    property,
                    value
                )
    ...
    ipcMain.handle(
        ...
        async (
            ...
            try {
                const change = visualEditorService.updateElementStyle(
                    elementId,
                    styleProperty,
                    value
                )
    ...
    // Undo
    ipcMain.handle('visual-editor-undo', async () => {
        try {
    ...
    // Redo
    ipcMain.handle('visual-editor-redo', async () => {
        try {
    ...
    // Check can undo
    ipcMain.handle('visual-editor-can-undo', async () => {
        try {
    ...
    // Check can redo
    ipcMain.handle('visual-editor-can-redo', async () => {
        try {
    ...
    // Get changes
    ipcMain.handle('visual-editor-get-changes', async () => {
        try {
    ...
    // Clear changes
    ipcMain.handle('visual-editor-clear-changes', async () => {
        try {
    ...
    // Get change history
    ipcMain.handle('visual-editor-get-history', async () => {
        try {
    ...
    ipcMain.handle(
        ...
        async (_event: IpcMainInvokeEvent, code: string, filePath: string) => {
            try {
                const elements = visualEditorService.parseCodeToElements(
                    code,
                    filePath
                )
    ...
    ipcMain.handle(
        ...
        async (_event: IpcMainInvokeEvent, elements: any[]) => {
            try {
                const code =
                    visualEditorService.generateCodeFromElements(elements)
    ...
    // Get state
    ipcMain.handle('visual-editor-get-state', async () => {
        try {
    ...
    // Reset
    ipcMain.handle('visual-editor-reset', async () => {
        try {
