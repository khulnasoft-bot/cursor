...
export class BrowserAutomationClient {
    ...
    ): Promise<BrowserAutomationResult<{ sessionId: string }>> {
    ...
    async extractText(
        sessionId: string,
        selector?: string
    ): Promise<BrowserAutomationResult<{ text: string }>> {
        return await ipcRenderer.invoke(
    ...
    async extractHTML(
        sessionId: string,
        selector?: string
    ): Promise<BrowserAutomationResult<{ html: string }>> {
        return await ipcRenderer.invoke(
    ...
    async screenshot(
        sessionId: string
    ): Promise<BrowserAutomationResult<{ screenshot: string }>> {
        return await ipcRenderer.invoke(
    ...
    async executeScript(
        sessionId: string,
        script: string
    ): Promise<BrowserAutomationResult<{ result: any }>> {
        return await ipcRenderer.invoke(
    ...
    async waitForSelector(
        ...
        selector: string,
        timeout?: number
    ): Promise<BrowserAutomationResult<{ found: boolean }>> {
        return await ipcRenderer.invoke(
    ...
    async getUrl(
        sessionId: string
    ): Promise<BrowserAutomationResult<{ url: string }>> {
        return await ipcRenderer.invoke('browser-automation-get-url', sessionId)
    }

    async getTitle(
        sessionId: string
    ): Promise<BrowserAutomationResult<{ title: string }>> {
        return await ipcRenderer.invoke(
